...
providersData: ReturnType<typeof useOpenCode>["providersData"];
  ...
  permissionQueue: ReturnType<typeof useOpenCode>["permissionQueue"];
  addPermission: ReturnType<typeof useOpenCode>["addPermission"];
  removePermission: ReturnType<typeof useOpenCode>["removePermission"];
  getPermissionById: ReturnType<typeof useOpenCode>["getPermissionById"];
