...
if (!fs.existsSync(distPath)) {
  console.error(
    "ERROR: dist directory not found. Please build the package first.",
  );
  process.exit(1);
}
...
if (distFiles.length === 0) {
  console.error(
    "ERROR: dist directory is empty. Please build the package first.",
  );
  process.exit(1);
}
...
if (!fs.existsSync(distServerPath)) {
  console.error(
    "ERROR: dist/server directory not found. Please build the package first.",
  );
  process.exit(1);
}
